function [verdict,timeVerdictActive,criticalityVerdict,timeFirstFailureExhibited] = executeTestElevator(model)
    ...
    % open_system([model '/' signalBuilderBlock], 'force');
    % signalbuilder([model '/' signalBuilderBlock], 'activegroup', testCase);
    % open_system([correct_model_name '/' signalBuilderBlock], 'force');
    ...
    verdict = abs(incorrect_out.correct_out1.data - correct_out.out1.data) + ...
              abs(incorrect_out.correct_out2.data - correct_out.out2.data) + ...
