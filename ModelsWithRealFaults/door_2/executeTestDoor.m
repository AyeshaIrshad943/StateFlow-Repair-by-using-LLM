...
%     out3 = ans.out3.data;
    ...
    % disp('timeFirstFailureExhibited is ')
    % disp(timeFirstFailureExhibited)
    % disp('criticalityVerdict is ')
    % disp(criticalityVerdict)
    % disp('verdict is ')
    % disp(verdict)
    % disp('timeVerdictActive is ')
    % disp(timeVerdictActive)
